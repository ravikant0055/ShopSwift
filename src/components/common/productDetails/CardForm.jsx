    ...
    <div className="cardForm_wrapper">
      <div className="cardForm_form">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="">
            {full && <div className="flex gap-5 items-center mb-7">
            ...
            <div>
              <button
                className={`border w-full text-sm border border-gray-300 font-semibold py-[13px] text-center mr-4 rounded-md mb-7 border-2 hover:border-black ${!selectedSize && 'text-gray-300'}`}
                type="submit"
